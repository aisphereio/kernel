...
var CmdClient = &cobra.Command{
	...
	Long:  "Generate the proto client code. Example: kernel proto client helloworld.proto",
	Run:   run,
}
...
func generate(proto string, args []string) error {
	...
	inputExt := []string{
		"--proto_path=" + base.KernelMod(),
		"--proto_path=" + filepath.Join(base.KernelMod(), "third_party"),
