...
import (
	...
	"github.com/aisphereio/kernel/cmd/protoc-gen-go-errors/errors"
)

const (
	errorxPackage = protogen.GoImportPath("github.com/aisphereio/kernel/errorx")
	fmtPackage    = protogen.GoImportPath("fmt")
)

var enCases = cases.Title(language.AmericanEnglish, cases.NoLower)

// generateFile generates a _errors.pb.go file containing kernel errors definitions.
func generateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	...
	g.P("// Code generated by protoc-gen-go-errors for errorx. DO NOT EDIT.")
	g.P()
...
// generateFileContent generates the kernel errors definitions, excluding the package statement.
func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile) {
	...
	g.P("// is compatible with the kernel package it is being compiled against.")
	g.P("const _ = ", errorxPackage.Ident("SupportPackageIsVersion1"))
	g.P()
	index := 0
