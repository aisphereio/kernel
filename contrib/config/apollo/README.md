...
This module implements the `config.Source` interface in kernel based apollo config management center.

[![go.dev reference](https://img.shields.io/badge/go.dev-reference-007d9c?logo=go&logoColor=white&style=flat-square)](https://pkg.go.dev/github.com/aisphereio/kernel/contrib/config/apollo/v3)
...
you got them in kernel config instance maybe look like:
