...
// Aisphere Kernel needs to cooperate with the following fields to run properly on Kubernetes:
// kernel-service-id: define the ID of the service
// kernel-service-app: define the name of the service
// kernel-service-version: define the version of the service
// kernel-service-metadata: define the metadata of the service
// kernel-service-protocols: define the protocols of the service
//
// Example Deployment:
/*
apiVersion: apps/v1
...
template:
  metadata:
    labels:
      app: nginx
      kernel-service-id: "56991810-c77f-4a95-8190-393efa9c1a61"
      kernel-service-app: "nginx"
      kernel-service-version: "v3.5.0"
    annotations:
      kernel-service-protocols: |
        {"80": "http"}
...
const (
	...
	LabelsKeyServiceID = "kernel-service-id"
	// LabelsKeyServiceName is used to define the name of the service
	LabelsKeyServiceName = "kernel-service-app"
	// LabelsKeyServiceVersion is used to define the version of the service
	LabelsKeyServiceVersion = "kernel-service-version"
	// AnnotationsKeyMetadata is used to define the metadata of the service
	AnnotationsKeyMetadata = "kernel-service-metadata"
	// AnnotationsKeyProtocolMap is used to define the protocols of the service
	// Through the value of this field, Aisphere Kernel can obtain the application layer protocol corresponding to the port
	// Example value: {"80": "http", "8081": "grpc"}
	AnnotationsKeyProtocolMap = "kernel-service-protocols"
)
