...
func TestNew(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "hello",
			args: args{[]map[string][]string{{"hello": {"kernel"}}, {"hello2": {"aisphereio"}}}},
			want: Metadata{"hello": {"kernel"}, "hello2": {"aisphereio"}},
		},
		{
			name: "hi",
			args: args{[]map[string][]string{{"hi": {"kernel"}}, {"hi2": {"aisphereio"}}}},
			want: Metadata{"hi": {"kernel"}, "hi2": {"aisphereio"}},
		},
	}
...
func TestMetadata_Get(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "kernel",
			m:    Metadata{"kernel": {"value"}, "env": {"dev"}},
			args: args{key: "kernel"},
			want: "value",
		},
		{
			name: "env",
...
func TestMetadata_Values(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "kernel",
			m:    Metadata{"kernel": {"value", "value2"}, "env": {"dev"}},
			args: args{key: "kernel"},
...
func TestMetadata_Set(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name: "kernel",
			m:    Metadata{},
			args: args{key: "hello", value: "kernel"},
			want: Metadata{"hello": {"kernel"}},
		},
		{
			name: "env",
			m:    Metadata{"hello": {"kernel"}},
			args: args{key: "env", value: "pro"},
			want: Metadata{"hello": {"kernel"}, "env": {"pro"}},
		},
		{
			name: "empty",
			m:    Metadata{},
...
func TestMetadata_Add(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want: Metadata{"hello": {"kernel", "again"}},
		},
		{
			name: "empty",
			m:    Metadata{},
...
func TestClientContext(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "kernel",
			args: args{context.Background(), Metadata{"hello": {"kernel"}, "kernel": {"https://kernel.aisphere.io"}}},
		},
		{
			name: "hello",
			args: args{context.Background(), Metadata{"hello": {"kernel"}, "hello2": {"https://kernel.aisphere.io"}}},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestAppendToClientContext(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "kernel",
			args: args{Metadata{}, []string{"hello", "kernel", "env", "dev"}},
			want: Metadata{"hello": {"kernel"}, "env": {"dev"}},
		},
		{
			name: "hello",
			args: args{Metadata{"hi": {"https://kernel.aisphere.io/"}}, []string{"hello", "kernel", "env", "dev"}},
			want: Metadata{"hello": {"kernel"}, "env": {"dev"}, "hi": {"https://kernel.aisphere.io/"}},
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestMergeToClientContext(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "kernel",
			args: args{Metadata{}, Metadata{"hello": {"kernel"}, "env": {"dev"}}},
			want: Metadata{"hello": {"kernel"}, "env": {"dev"}},
		},
		{
			name: "hello",
			args: args{Metadata{"hi": {"https://kernel.aisphere.io/"}}, Metadata{"hello": {"kernel"}, "env": {"dev"}}},
			want: Metadata{"hello": {"kernel"}, "env": {"dev"}, "hi": {"https://kernel.aisphere.io/"}},
		},
	}
	for _, tt := range tests {
...
func TestMetadata_Range(t *testing.T) {
	md := Metadata{"kernel": {"kernel"}, "https://kernel.aisphere.io/": {"https://kernel.aisphere.io/"}, "aisphereio": {"aisphereio"}}
	tmp := Metadata{}
	md.Range(func(k string, v []string) bool {
		if k == "https://kernel.aisphere.io/" || k == "kernel" {
			tmp[k] = v
		}
		return true
	})
	if !reflect.DeepEqual(tmp, Metadata{"https://kernel.aisphere.io/": {"https://kernel.aisphere.io/"}, "kernel": {"kernel"}}) {
		t.Errorf("metadata = %v, want %v", tmp, Metadata{"https://kernel.aisphere.io/": {"https://kernel.aisphere.io/"}, "kernel": {"kernel"}})
	}
	tmp = Metadata{}
...
func TestMetadata_Clone(t *testing.T) {
	tests := []struct {
		...
		{
			name: "kernel",
			m:    Metadata{"kernel": {"kernel"}, "https://kernel.aisphere.io/": {"https://kernel.aisphere.io/"}, "aisphereio": {"aisphereio"}},
			want: Metadata{"kernel": {"kernel"}, "https://kernel.aisphere.io/": {"https://kernel.aisphere.io/"}, "aisphereio": {"aisphereio"}},
		},
		{
			name: "go",
