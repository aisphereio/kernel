...
import (
	...
	"github.com/aisphereio/kernel/transport/grpc/resolver/discovery"

	// init resolver
	_ "github.com/aisphereio/kernel/transport/grpc/resolver/direct"
)
...
func (w *wrappedClientStream) SendMsg(m any) error {
	h := func(_ context.Context, req any) (any, error) {
		return req, fromGRPCError(w.ClientStream.SendMsg(m))
	}
...
func (w *wrappedClientStream) RecvMsg(m any) error {
	h := func(_ context.Context, req any) (any, error) {
		return req, fromGRPCError(w.ClientStream.RecvMsg(m))
	}
