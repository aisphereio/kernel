...
handler with Aisphere Kernel decorators. Attach fixed service attrs with `logger.With`.
...
The `github.com/aisphereio/kernel/contrib/otel/v3/log` handler bridges slog records to
OpenTelemetry Logs. Use the core log builder when you need Aisphere Kernel logger options:
