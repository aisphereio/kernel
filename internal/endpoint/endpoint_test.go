...
func TestNewEndpoint(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{"https", "github.com/aisphereio/kernel/"},
			want: &url.URL{Scheme: "https", Host: "github.com/aisphereio/kernel/"},
		},
		{
			name: "https://kernel.aisphere.io/",
			args: args{"https", "kernel.aisphere.io/"},
			want: &url.URL{Scheme: "https", Host: "kernel.aisphere.io/"},
		},
		{
...
func TestParseEndpoint(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:    "kernel",
			args:    args{endpoints: []string{"https://github.com/aisphereio/kernel"}, scheme: "https"},
			want:    "github.com",
			wantErr: false,
		},
		{
			name:    "test",
			args:    args{endpoints: []string{"http://kernel.aisphere.io/"}, scheme: "https"},
			want:    "",
			wantErr: false,
		},
		{
