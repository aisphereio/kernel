...
func TestContext(t *testing.T) {
	type ctxKey1 struct{}
	type ctxKey2 struct{}
	ctx1 := context.WithValue(context.Background(), ctxKey1{}, "https://github.com/aisphereio/")
	ctx2 := context.WithValue(context.Background(), ctxKey2{}, "https://kernel.aisphere.io/")
	...
	if !reflect.DeepEqual(value1, "https://github.com/aisphereio/") {
		t.Errorf("expect %v, got %v", "https://github.com/aisphereio/", value1)
	}
	...
	if !reflect.DeepEqual("https://kernel.aisphere.io/", value2) {
		t.Errorf("expect %v, got %v", "https://kernel.aisphere.io/", value2)
	}
...
func TestMerge(t *testing.T) {
	...
	cancel()
	ctx1 := context.WithValue(context.Background(), ctxKey1{}, "https://github.com/aisphereio/")
	ctx2 := context.WithValue(ctx, ctxKey2{}, "https://kernel.aisphere.io/")
	...
	if !reflect.DeepEqual(value2, "https://kernel.aisphere.io/") {
		t.Errorf("expect %v, got %v", " https://kernel.aisphere.io/", value2)
	}
