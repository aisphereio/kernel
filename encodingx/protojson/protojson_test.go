...
import (
	...
	testData "github.com/aisphereio/kernel/internal/testdata/encoding"
)
...
func TestCodec(t *testing.T) {
	...
	if got, want := strings.ReplaceAll(string(data), " ", ""), `{"id":"1","name":"aisphereio","hobby":["1","2"],"attrs":{}}`; got != want {
		t.Errorf("Marshal() = %s, want %s", got, want)
	}

	var out testData.TestModel
	if err := c.Unmarshal([]byte(`{"id":"1","name":"aisphereio","hobby":["1","2"],"unknown":"discarded"}`), &out); err != nil {
